...
myApp.c.appConfig = {
    ...
    appName: 'showJson',
    appSlogan: 'easy and fast',
    
    // nome do localStorage
    localStorageName: 'showJson',
...
myApp.c.navbarHide = function (pgName) {
    if ($.inArray(pgName, this.appConfig.navbarHide) === -1 && this.appConfig.navbarHide !== true) {
        ...
        $$('.page-content').css('padding-top', '42px');
    } else {
...
myApp.c.createHtmlPanel = function (itens) {
    var codHtml = '<div class="content-block content-panel">';
...
myApp.c.ajaxApi = function (method, params, callback) {
    var ajaxParams = {};
    ajaxParams.type = this.appConfig.typeAjax;
